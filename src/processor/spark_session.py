...
# def create_iceberg_spark_session_v1(external_ip: str, s3_access_key: str, s3_secret_key: str, iceberg_warehouse_path: str) -> SparkSession:
#     try:
#         # Spark configuration
#         conf = SparkConf()
        
#         # Set up packages with AWS SDK v1
...
#         conf.set("spark.sql.catalog.iceberg.type", "hadoop")  # Hadoop 카탈로그 사용
